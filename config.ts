export const config = {
  "alerts": [
    ...
    }, 
    {
      ...
      "filter": (data: any) => {
          ...
          const raw_log_topics_filter_2 = "0x9026A229b535ecF0162Dfe48fDeb3c75f7b2A7AE"
          let ping = false;
  ...
  }, 
  {
    ...
    "filter": (data: any) => {
        ...
        const raw_log_topics_filter_2 = "0x56D8B635A7C88Fd1104D23d632AF40c1C3Aac4e3"
        const raw_log_topics_filter_3 = "0xD417144312DbF50465b1C641d016962017Ef6240"
        let ping = false;


        for(const i of data.log_events){
            if(i.raw_log_topics[0] === raw_log_topics_filter_1){
              if(i.raw_log_topics[1] === raw_log_topics_filter_2){
                if(i.sender_address === raw_log_topics_filter_3){
                    ping = true;
                    break;
                }
              }
